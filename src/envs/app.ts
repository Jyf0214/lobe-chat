...
export const getAppConfig = () => {
  ...
  return createEnv({
    client: {
      ...
      VITE_APP_CDN_USE_GLOBAL: z.boolean().optional(),
      VITE_APP_CUSTOM_FONT_FAMILY: z.string().optional(),
      VITE_APP_CUSTOM_FONT_URL: z.string().optional(),
    },
    server: {
    ...
    runtimeEnv: {
      ...
      VITE_APP_CDN_USE_GLOBAL:
        process.env.VITE_APP_CDN_USE_GLOBAL === '1' || process.env.CDN_USE_GLOBAL === '1',
      VITE_APP_CUSTOM_FONT_FAMILY:
        process.env.VITE_APP_CUSTOM_FONT_FAMILY || process.env.CUSTOM_FONT_FAMILY,
      VITE_APP_CUSTOM_FONT_URL: process.env.VITE_APP_CUSTOM_FONT_URL || process.env.CUSTOM_FONT_URL,
