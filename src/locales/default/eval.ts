export default {
  ...
  'run.create.agent': 'Target Agent',
  'run.create.agent.placeholder': 'Select an agent (optional)',
  ...
  'run.create.name.placeholder': 'Enter a name (optional)',
  ...
  'testCase.create.expected.placeholder': 'Enter the expected answer (optional)',
