...
export const userRouter = router({
  ...
  updateAvatar: userProcedure
    .input(stringWithByteLimit(PAYLOAD_SIZE_LIMITS.AVATAR_BASE64, 'avatar'))
  ...
  updateSettings: userProcedure
    .input(withPayloadSizeLimit(UserSettingsSchema, PAYLOAD_SIZE_LIMITS.USER_SETTINGS, 'settings'))
    .mutation(async ({ ctx, input }) => {
